...
static const char *TAG = "my_mqtt_client";

static const char *g_pub_topic = "topic/esp_data";
static const char *g_sub_topic = "topic/broker_data";
...
void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_publish(mqtt_client, g_pub_topic, "yay", 0, 1, 0);
        ESP_LOGI(TAG, "sent publish successful, msg_id=%d", msg_id);

        msg_id = esp_mqtt_client_subscribe(mqtt_client, g_sub_topic, 0);
